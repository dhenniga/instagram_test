...
import com.tag.instagramtest.InstagramDialog;
import com.tag.instagramtest.InstagramSession;
import com.tag.instagramtest.Utils;
		...
		new Thread() {
			...
			public void run() {
				...
				try {
					...
					String full_name = jsonObj.getJSONObject("user").getString("full_name");
					String profile_picture = jsonObj.getJSONObject("user").getString("profile_picture");

					mSession.storeAccessToken(mAccessToken, id, username, full_name, profile_picture);
